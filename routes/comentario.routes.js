 ...
 */
router.get("/", comentarioController.get_comentarios);
 ...
 */
router.get("/:articulo", comentarioController.get_comentario_by_articulo);
 ...
 */
router.post("/",comentarioController.add_comentario);
 ...
 */
router.patch("/:id", comentarioController.edit_comentario);
 ...
 */
router.delete("/:id", comentarioController.delete_comentario_by_id);
 ...
 */
router.delete("/articulo", comentarioController.delete_comentario_by_articulo);
